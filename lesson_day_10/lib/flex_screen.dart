...
class DemoExpanded extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const SizedBox(
      ...
      child: Row(
        children: [
          LabeledContainer(text: '100',
          color: Colors.green,
          width: 100,),
          Expanded(
            child: LabeledContainer(text: "Uldegdel heseg",
            color: Colors.purple,
            textColor: Colors.white,),
          ),
          LabeledContainer(text: '40',
          color: Colors.green,
          width: 40,)
        ],
      ),
...
class DemoFlexible extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const SizedBox(
      ...
      child: Row(
        children: [
          Flexible(child: LabeledContainer(text: "25%" ,color: Colors.orange,)),
          Flexible(flex: 1,
